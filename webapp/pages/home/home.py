...
mouse_data_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button("Close", id="mouse-data-close", className="ms-auto", n_clicks=0)
        ),
    ],
    id="mouse-data-modal",
    scrollable=True,
...
human_data_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button("Close", id="human-data-close", className="ms-auto", n_clicks=0)
        ),
    ],
    id="human-data-modal",
    scrollable=True,
...
custom_data_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button("Close", id="custom-data-close", className="ms-auto", n_clicks=0)
        ),
    ],
...
differentiation_score_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button(
                "Close",
                id="differentiation-score-close",
                className="ms-auto",
                n_clicks=0,
            )
        ),
...
feature_columns_dataset_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button(
                "Close",
                id="feature-columns-dataset-close",
                className="ms-auto",
                n_clicks=0,
            )
        ),
...
time_unit_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button("Close", id="time-unit-close", className="ms-auto", n_clicks=0)
        ),
    ],
    id="time-unit-modal",
    scrollable=True,
...
log_ratio_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button("Close", id="log-ratio-close", className="ms-auto", n_clicks=0)
        ),
    ],
    id="log-ratio-modal",
    scrollable=True,
...
feature_columns_trajectory_modal = dbc.Modal(
    [
        ...
        dbc.ModalFooter(
            dbc.Button(
                "Close",
                id="feature-columns-trajectory-close",
                className="ms-auto",
                n_clicks=0,
            )
        ),
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            [
                                dhc.Div(
                                    dcc.Store(id="upload-data-file-path"), hidden=True
                                ),
                                dhc.Div(
                                    du.Upload(
                                        id="upload-data",
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            dcc.Loading(
                                id="loading-boxes",
                                children=dhc.Div(id="upload-infobox"),
                                type="default",
                            ),
                            width=6,
                        ),
                ...
                dbc.Row(
                    dbc.Col(
                        [
                            ...
                            dhc.Br(),
                            dhc.Div(
                                children=trajectory_settings, id="trajectory-settings"
                            ),
                            dhc.Br(),
                            dhc.Br(),
                            dhc.Hr(),
